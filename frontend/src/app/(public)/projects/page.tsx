...
export default function ProjectsPage() {
    return <div className="bg-[#f6f3eb] text-[#183b35]"><section className="grid lg:grid-cols-2"><div className="flex flex-col justify-center px-6 py-16 sm:px-12 lg:pl-[max(3rem,calc((100vw-1280px)/2+1.5rem))]"><h1 className="font-display text-5xl font-bold leading-[1.06] tracking-tight sm:text-6xl">Our work,<br />in action.</h1><p className="mt-7 max-w-lg text-base leading-7 text-[#53645f]">Explore the projects that put child protection, learning, and community participation into practice.</p><a href="#project-directory" className="mt-7 flex min-h-11 w-fit items-center gap-3 rounded-full border border-[#183b35] px-5 text-sm font-semibold">Explore projects <ArrowDown aria-hidden="true" className="size-4" /></a></div><div className="relative min-h-72 lg:min-h-[460px]"><Image src="/assets/plates/program-photo.webp" alt="A woman participating in a community activity" fill priority sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover" /></div></section><ProjectsDirectory /></div>;
}
